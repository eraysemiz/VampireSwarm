...
public class ThunderLoopWeapon : ProjectileWeapon
{
    ...
    IEnumerator Strike()
    {
        ...
        ParticleSystem thunderLoopVFX = Instantiate(currentStats.hitEffect, strikePosition, Quaternion.Euler(0, 0, 0));
        ...
        thunderLoopVFX.transform.rotation = Quaternion.Euler(0, 0, randomAngle);
